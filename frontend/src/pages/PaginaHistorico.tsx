...
function LinhasGastos({ gastos }: { gastos: Gasto[] }): JSX.Element {
    return (
        <>
            {gastos.map((g) => (
                <tr
                ...
                >
                    ...
                    <td style={{ color: "#94a3b8" }} className="px-4 py-3">
                        {g.categoria_nome ?? "—"}
                    </td>
                    <td style={{ color: "#94a3b8" }} className="px-4 py-3">
                        {formatDate(g.data)}
...
function LinhasEntradas({ entradas }: { entradas: Entrada[] }): JSX.Element {
    return (
        <>
            {entradas.map((e) => (
                <tr
        ...
        <div className="flex gap-2 mb-6">
            {(["gastos", "entradas"] as View[]).map((v) => (
                <button
                    ...
                    style={{
                        backgroundColor: view === v ? "#22c55e" : "#16213e",
...
function TabelaHistorico({
    ...
    data: PaginatedResponse<Gasto> | PaginatedResponse<Entrada>;
    view: View;
    currentPage: number;
    setPage: SetPage;
}): JSX.Element {
            ...
            >
                <table className="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        {view === "gastos" ? (
                            <LinhasGastos gastos={data.results as Gasto[]} />
                        ) : (
                            <LinhasEntradas
                                entradas={data.results as Entrada[]}
                            />
                        )}
                    </tbody>
                </table>
...
export default function PaginaHistorico(): JSX.Element {
    ...
    return (
        <div>
            ...
            <BotoesView view={view} setView={setView} />
