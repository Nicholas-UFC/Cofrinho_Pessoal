...
describe("CadastroPage — regressão paginação", () => {
...
describe("CadastroPage — formulário de Gasto", () => {
...
describe("CadastroPage — formulário de Entrada", () => {
    it("submit bem-sucedido exibe mensagem de sucesso", async () => {
        await renderCadastro();
        await userEvent.click(
            screen.getByRole("button", { name: /entrada/i }),
...
describe("CadastroPage — formulário de Categoria", () => {
    it("submit bem-sucedido exibe mensagem de sucesso", async () => {
        await renderCadastro();
        await userEvent.click(
            screen.getByRole("button", { name: /categoria/i }),
...
describe("CadastroPage — formulário de Fonte", () => {
    it("submit bem-sucedido exibe mensagem de sucesso", async () => {
        await renderCadastro();
        await userEvent.click(screen.getByRole("button", { name: /fonte/i }));
        await userEvent.type(
